...
<div className="phone "><a id="address" className="" href={`tel:${location.mainPhone}`}>{location.mainPhone}</a>
      ...
      <a className={cssClasses.ctaButton} href="https://www.fooddocs.com/restaurant-checklists">Contect</a>
      <a className={cssClasses.ctaButton} href="https://www.bing.com/maps?&ty=17&q=restaurant%20url&segment=Local&sei=0&cp=26.911512~75.824219&child=%26ty%3D18%26q%3DSheesh%2520Mahal%2520Restaurant%26ss%3Dypid.YN4070x15547851255390976076%26segment%3DLocal%26ppois%3D26.91151237487793_75.82421875_Sheesh%2520Mahal%2520Restaurant_YN4070x15547851255390976076~%26cp%3D26.911512~75.824219%26EnableMapViewChange%3Dtrue&FORM=SNAPST">Get Direction</a>
      {screenSize !== 'sm' && (
